  ...
  const avisData = [
    {
      ...
      comment:
        "Simple, rapide et efficace ! Une équipe à l'écoute ! Je recommande vivement !",
      rating: 5.0,
      date: "2023-09-19",
    },
    {
    ...
    },
    {
      ...
      userImage: Avatar2,
      comment:
        "Excellente expérience humaine vécue avec Tristan de Sko qui me guidera sur chaques routes ! Merci encore 🙏",
      rating: 5.0,
      date: "2023-09-19",
    },
    {
