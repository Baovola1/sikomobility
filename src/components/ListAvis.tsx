...
const ListAvis: React.FC<ListAvisProps> = ({ username, userImage, comment, rating, date }) => {
  ...
  <div className="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800">
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="flex items-center">
        {stars} 
        <span className="ml-2 text-yellow-400 text-xs">{rating.toFixed(1)}</span> {/* Affichage note avec un chiffre après virgule */}
      </div>
    </div>
